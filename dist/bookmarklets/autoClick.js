"use strict";
javascript: (function () { let intervalInput = window.prompt("What do you want the interval to be? (in milliseconds) ex: 1000"); if (!intervalInput) {
    ...
    if (isNaN(interval) || interval <= 0) {
        ...
        if (!doggie) {
            ...
            setInterval(() => { doggie.click(); }, interval);
        }
    }
} })();
